    ...
    <div className="lg:pt-[117px]">
      <section className="pt-36 block lg:flex justify-between lg:pt-0 ">
        <div className=" px-4 md:mx-[5rem] lg:mx-[3rem] lg:w-[55%] 2xl:mx-[20rem] my-auto">
          <h2 className="mb-6  font-bold  lg:mb-8">What I Do</h2>
      ...
      <section className=" bg-accent-100 lg:flex justify-around bg-gradient-to-b from-accent-50 to-accent-100 py-11 2xl:pt-28">
        ...
        <div className="px-8 mx-[2rem] my-auto">
          <h2 className=" text-center md:text-left font-bold mb-3">
            {" "}
            Meet The Founder
          </h2>
          ...
          <br />
          <p>
            At Creative Cate, I'm not just about delivering products or
            services; I'm about creating lasting relationships and driving
            positive change. My commitment to integrity, creativity, and
            customer satisfaction is reflected in every aspect of our business.
            Together with my dedicated team, I am excited to embark on this
            journey, shaping the future of your company and making a difference,
      ...
      <section className="py-12">
        <div className="bg-white pt-3 px-8  lg:px-[4rem] lg:max-w-[200rem] mx-auto">
          <div className="">
            <h2 className="mb-3 text-center">Why Choose Me?</h2>
            <p className="mb-10 text-center">
              Choose me for a partner dedicated to your success. With a proven
              track record of delivering exceptional results and a commitment to
              personalized service, I prioritize your goals as if they were my
              own. From innovative solutions to unwavering support, I am here to
              exceed your expectations and drive lasting impact for your
              business.
            </p>
          </div>
          <div className="flex flex-col md:flex-row flex-wrap justify-center">
            <div className=" border-l border-sub-DEFUALT pl-5 mb-10 py-4 pr-10   lg:w-[420px]">
              ...
              <p className="text-secondary font-semibold">
                Choose me for a burst of fresh creativity tailored to your
                needs. With a passion for innovation and a track record of
                driving results, I offer dynamic solutions to propel your
            ...
            <div className=" border-l border-sub-DEFUALT pl-5 mb-10 py-4 pr-10 lg:w-[420px]">
              ...
              <p className="text-secondary font-semibold">
                Choose me to stay ahead in an ever-evolving landscape. With a
                commitment to continuous learning and a finger on the pulse of
                industry trends, I provide timely insights and strategies to
                keep you at the forefront. Stay competitive and relevant with my
            ...
            <div className=" border-l border-sub-DEFUALT pl-5 mb-10 py-4 pr-10 lg:w-[420px]">
              ...
              <p className="text-secondary font-semibold">
                Choose me for streamlined solutions that cut through the noise.
                With a keen eye for priorities and a commitment to efficiency, I
                deliver targeted strategies that drive meaningful results. Trust
                me to help you stay focused on what truly moves the needle for
                your success.
              </p>
            </div>
            <div className=" border-l border-sub-DEFUALT pl-5 mb-10 py-4 lg:w-[420px]">
              ...
              <p className="text-secondary font-semibold">
                Choose me to reclaim precious time for what truly matters. With
                streamlined processes and efficient solutions, I ensure optimal
                productivity without sacrificing quality. Let me handle the
