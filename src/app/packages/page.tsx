      ...
      <section className="block lg:flex justify-between lg:pt-0 ">
        <div className="flex flex-col justify-center mb-8 px-4 md:mx-[5rem] lg:mx-[4rem] lg:w-[50%] 2xl:mx-[20rem]">
          ...
          <p className="mb-14 text-secondary font-medium">
            Explore a range of tailored solutions designed to
            elevate your brand and online presence. From comprehensive branding
            packages that define your identity to expertly crafted social media
            strategies that engage your audience, each offering is meticulously
            curated to meet your specific needs. Dive into the world of digital
            marketing with ease through our website creation packages, designed
            to establish a strong online presence and drive meaningful
            connections with your target audience. With these packages, you're
            not just investing in services; you're investing in the future
